  ...
  <div  id="fh5co-contact">
    <div class="container">
      ...
      <div class="text">
        ...
        <p class="font18 wow fadeInUp">
          這是以《政府網站版型與內容管理規範》中為基礎的隱私權政策範本，稍微調整過移除不適用一般企業的項目，任何網站皆可將此範本加上自己的網站名稱，並做修改後使用於網站上。
        </p>
        <br />
        <p class="font18 wow fadeInUp">
          我們會定期更新這個範本，以求更加完善化。若您有新的建議，歡迎前往本範本文件的
          GitHub 提交修改建議。
        </p>
        <p class="font18 wow fadeInUp">
          請注意，若您要針對此以私權政策模板做修改，需要至少包含以下項目:
        </p>
        <ul class="list">
          ...
          <li class="wow fadeInUp">
            <h4>六、Cookie之使用</h4>
            <p>請說明該網站使用 Cookie 技術來儲存或追蹤使用者的資料的情況。</p>
          </li>
          <li class="wow fadeInUp">
            <h4>七、隱私權保護政策之修正</h4>
      ...
      <h3 class="wow fadeInDown">隱私權條款範本文件</h3>
      <div class="text">
        <!-- 編輯器 開始 -->

        <p class="font18 wow fadeInUp">
          非常歡迎您光臨「善得人本官方網站」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
        </p>
        <ul class="list">
          <li class="wow fadeInUp">
            <h4>一、隱私權保護政策的適用範圍</h4>
